...
import mobileIcon from "/Mobile_logo-min.png";
import GradientBorderMotion from "./GradientBorderMotion";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import { faCircleCheck } from "@fortawesome/free-solid-svg-icons";

const features = [
  ["iOS App Design", "Android App Design"],
  ["Cross-Platform Design", "Interactive Prototypes"],
...
const MobileAppsSection = () => (
  <section className="w-full min-h-[60vh] bg-[#181818] flex flex-col md:flex-row items-start md:items-center justify-between px-4 md:px-20 py-12">
    ...
    <div className="flex flex-col items-center md:items-start w-full md:w-[45%]">
      <img src={mobileIcon} alt="Mobile Icon" className="w-8 h-8 mb-4" />
      <h2
      ...
      <p className="text-[#bdbdbd] text-lg text-center md:text-left mb-10 max-w-lg">
        Every great app starts with a simple idea. We turn that spark into
        sleek, user-centered mobile designs that captivate, engage, and deliver
        seamless experiences from the very first tap.
      </p>
